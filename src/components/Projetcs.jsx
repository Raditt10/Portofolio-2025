...
const Projects = () => {
  ...
  return (
    <section 
      id="projects" 
      ref={sectionRef} 
      className="relative min-h-screen py-20 sm:py-24 md:py-32 px-4 sm:px-6 overflow-hidden bg-gradient-to-br from-[#040507] via-[#0a0d12] to-[#050608] mt-20 sm:mt-24 md:mt-32"
      style={{ 
